    ...
    try {
      ...
      setFormData({
        ...
        employment: employee.employment ? {
          entity_id: employee.employment.entity_id || '',
          position_id: employee.employment.position_id || 0,
          employment_type: employee.employment.employment_type || 'full_time',
          date_hired: employee.employment.date_hired || '',
          date_terminated: employee.employment.date_terminated || '',
          leave_balance: employee.employment.leave_balance || 0,
        } : {
          entity_id: '',
          position_id: 0,
          employment_type: 'full_time',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.employment.entity_id && formData.employment.position_id > 0) {
        ...
        if (formData.employment.date_terminated) {
          submitData.employment.date_terminated = formData.employment.date_terminated;
        }
      }
