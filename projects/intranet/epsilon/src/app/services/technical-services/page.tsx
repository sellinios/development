...
export default function PreVetting() {
  const originalContent = (
    <>
      ...
      {/* ONE EVENTUAL AIM Section - Matching exactly as per image */}
      <div className="max-w-7xl mx-auto py-12 px-4">
        ...
        <div className="text-lg">
          <p className="mb-8">
            Enhancing the likelihood for <span className="text-blue-600">high inspection scores</span> during formal audits and RightShip inspections,
          </p>

          <p className="mb-4">Contact point:</p>

          <p className="mb-2">Konstantinos Fetintze – <span className="text-blue-600">kfetintze@epsilonhellas.com</span></p>
          <p className="mb-2">Mobile: +30 69 7443 7304</p>
        </div>
      </div>
    </>
  );
