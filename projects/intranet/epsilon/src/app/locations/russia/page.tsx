  ...
  useEffect(() => {
    if (showMapPopup && !mapInitializedRef.current) {
      ...
      import('leaflet').then(L => {
        ...
        // Define the coordinates for Novorossiysk, Russia
        const novorossiysk: LatLngTuple = [44.7231, 37.7675]; // [latitude, longitude]
        ...
        const marker = L.marker(novorossiysk, { icon: customIcon }).addTo(map);
        marker.bindPopup("EPSILON SERVICES LTD<br>Pr. Dzerzhinskogo Yuzhnaya Str., Novorossiysk").openPopup();
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-96 w-full bg-gradient-to-r from-blue-800 to-blue-600 flex items-center">
        <div className="absolute inset-0 opacity-30">
          <Image
            src="/Home2.jpg"
            alt="Russia maritime background"
            fill
        ...
        <div className="container mx-auto px-4 z-10">
          <h1 className="text-5xl font-bold text-white mb-4">Russia</h1>
        </div>
      </section>
      ...
      <section className="container mx-auto py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-10">
            <h2 className="text-3xl font-bold text-center text-blue-800 mb-6">Our Presence in Russia</h2>
            
            <p className="text-lg mb-6">
              The history, size and achievements of the Russian nation are inextricably intertwined with the sea. This legacy has led to the generation of a highly competent seafaring base, with particular expertise and know-how in the smooth running of tanker vessels.
            </p>

            <p className="text-lg mb-8">
              Epsilon is present in Russia through Epsilon Novo, its local office in Novorossiysk, one of the main maritime gateways of the country to the rest of the world.
            </p>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-blue-50 p-6 rounded-lg shadow-md mb-8">
              <h3 className="text-2xl font-semibold mb-4 text-blue-800">EPSILON SERVICES LTD</h3>
              <div>
                <p className="mb-2">
                  353925, Russia, Novorossiysk 224/3 (Office 5) Pr. Dzerzhinskogo Yuzhnaya Str.
                </p>
                <p className="mb-4">
                  <strong>Tel:</strong> +7 8617 76 61 40<br />
                  <strong>Email:</strong> recruitment@epsilonnovo.ru
                </p>
                <button
            ...
            <div className="bg-white border border-gray-200 p-8 rounded-lg shadow-md">
              ...
              <p className="mb-6">Send us a message and our team in Russia will get back to you as soon as possible.</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-lg shadow-lg w-11/12 md:w-3/4 lg:w-2/3 max-w-4xl mx-auto overflow-hidden">
            <div className="p-4 border-b flex justify-between items-center">
              <h3 className="text-xl font-semibold">Epsilon Services Ltd - Novorossiysk, Russia</h3>
              <button
            ...
            <div className="p-4 bg-blue-50">
              <p>
                <strong>Address:</strong> 353925, Russia, Novorossiysk 224/3 (Office 5) Pr. Dzerzhinskogo Yuzhnaya Str.<br />
                <strong>Tel:</strong> +7 8617 76 61 40<br />
                <strong>Email:</strong> recruitment@epsilonnovo.ru
              </p>
            </div>
