  ...
  useEffect(() => {
    if (showMapPopup && !mapInitializedRef.current) {
      ...
      import('leaflet').then(L => {
        ...
        // Define the coordinates for Jakarta, Indonesia
        const jakarta: LatLngTuple = [-6.2088, 106.8456]; // [latitude, longitude]
        ...
        const marker = L.marker(jakarta, { icon: customIcon }).addTo(map);
        marker.bindPopup("ARJUNA SAMUDERA INDONESIA<br>Citi Hub, Jl. Boulevard Artha Gading, Jakarta").openPopup();
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-96 w-full bg-gradient-to-r from-blue-800 to-blue-600 flex items-center">
        <div className="absolute inset-0 opacity-30">
          <Image
            src="/Home2.jpg"
            alt="Indonesia maritime background"
            fill
        ...
        <div className="container mx-auto px-4 z-10">
          <h1 className="text-5xl font-bold text-white mb-4">Indonesia</h1>
        </div>
      </section>
      ...
      <section className="container mx-auto py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-10">
            <h2 className="text-3xl font-bold text-center text-blue-800 mb-6">Our Presence in Indonesia</h2>
            
            <p className="text-lg mb-8">
              Indonesia is an archetypical island nation which is historically associated with advanced maritime skills and seafaring traditions. Indonesian seafarers are employed by Western and Asian Principals across all types of vessels and have vast experience sailing international waters. The Jakarta-based office is ready to equip officers and crew in line with Epsilon’s highest quality standards.
            </p>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-blue-50 p-6 rounded-lg shadow-md mb-8">
              <h3 className="text-2xl font-semibold mb-4 text-blue-800">ARJUNA SAMUDERA INDONESIA</h3>
              <div>
                <p className="mb-2">
                  Citi Hub (ex : Harton Tower) Jl. 5th floor,<br />
                  Boulevard Artha Gading, Kepala Gading,<br />
                  Jakarta Utara, 14240 DKI Jakarta
                </p>
                <p className="mb-4">
                  <strong>Tel:</strong> +62 2122450785<br />
                  <strong>Email:</strong> recruitment@arjunamaritime.id
                </p>
                <button
            ...
            <div className="bg-white border border-gray-200 p-8 rounded-lg shadow-md">
              ...
              <p className="mb-6">Send us a message and our team in Indonesia will get back to you as soon as possible.</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-lg shadow-lg w-11/12 md:w-3/4 lg:w-2/3 max-w-4xl mx-auto overflow-hidden">
            <div className="p-4 border-b flex justify-between items-center">
              <h3 className="text-xl font-semibold">ARJUNA SAMUDERA INDONESIA - Jakarta, Indonesia</h3>
              <button
            ...
            <div className="p-4 bg-blue-50">
              <p>
                <strong>Address:</strong> Citi Hub (ex : Harton Tower) Jl. 5th floor, Boulevard Artha Gading, Kepala Gading, Jakarta Utara, 14240 DKI Jakarta<br />
                <strong>Tel:</strong> +62 2122450785<br />
                <strong>Email:</strong> recruitment@arjunamaritime.id
              </p>
            </div>
