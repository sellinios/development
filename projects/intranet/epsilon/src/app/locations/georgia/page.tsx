  ...
  useEffect(() => {
    if (showMapPopup && !mapInitializedRef.current) {
      ...
      import('leaflet').then(L => {
        ...
        // Define the precise coordinates for Epsilon Georgia office in Batumi
        const epsilonOffice: LatLngTuple = [41.6429, 41.6392];

        // Initialize the map
        const map = L.map('mapPopup', {
          center: epsilonOffice,
          zoom: 16,
          zoomControl: true,
        ...
        const marker = L.marker(epsilonOffice, { icon: customIcon }).addTo(map);
        marker.bindPopup("<strong>Epsilon Georgia</strong><br>Zhiuli Shartava ave 32<br>6000 Batumi, Georgia").openPopup();
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-96 w-full bg-gradient-to-r from-blue-800 to-blue-600 flex items-center">
        <div className="absolute inset-0 opacity-30">
          <Image
            src="/Home2.jpg"
            alt="Georgia maritime background"
            fill
        ...
        <div className="container mx-auto px-4 z-10">
          <h1 className="text-5xl font-bold text-white mb-4">Georgia</h1>
        </div>
      </section>
      ...
      <section className="container mx-auto py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-10">
            <h2 className="text-3xl font-bold text-center text-blue-800 mb-6">Our Presence in Georgia</h2>
            
            <p className="text-lg mb-6">
              The history of Georgian seamanship dates back to the 19th century. Currently, through a burgeoning community of seafarers and an unprecedented investment in its maritime training infrastructure, Georgia is quickly becoming one of the leading labour-supplying countries in the Black Sea.
            </p>

            <p className="text-lg mb-8">
              Our office is ideally located in the charming coastal city of Batumi. It is manned by the most respected professionals of the local maritime sector enabling us privileged access to the talented human resources the country has to offer.
            </p>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-blue-50 p-6 rounded-lg shadow-md mb-8">
              <h3 className="text-2xl font-semibold mb-4 text-blue-800">EPSILON GEORGIA</h3>
              <div>
                <p className="mb-2">
                  Zhiuli Shartava ave 32,<br />
                  6000 Batumi,<br />
                  Georgia
                </p>
                <p className="mb-4">
                  <strong>Tel:</strong> +995 555 333 016<br />
                  <strong>Email:</strong> cv@epsilongeorgia.com
                </p>
                <button
            ...
            <div className="bg-white border border-gray-200 p-8 rounded-lg shadow-md">
              ...
              <p className="mb-6">Send us a message and our team in Georgia will get back to you as soon as possible.</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-lg shadow-lg w-11/12 md:w-3/4 lg:w-2/3 max-w-4xl mx-auto overflow-hidden">
            <div className="p-4 border-b flex justify-between items-center">
              <h3 className="text-xl font-semibold">EPSILON GEORGIA - Batumi, Georgia</h3>
              <button
            ...
            <div className="p-4 bg-blue-50">
              <p>
                <strong>Address:</strong> Zhiuli Shartava ave 32, 6000 Batumi, Georgia<br />
                <strong>Tel:</strong> +995 555 333 016<br />
                <strong>Email:</strong> cv@epsilongeorgia.com
              </p>
            </div>
