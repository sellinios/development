  ...
  useEffect(() => {
    if (showMapPopup && !mapInitializedRef.current) {
      ...
      import('leaflet').then(L => {
        ...
        const constanta: LatLngTuple = [44.1765, 28.6521]; // [latitude, longitude]
        ...
        marker.bindPopup("EPSILON HELLAS OVERSEAS LTD\n<br>111 Ion Lahovari Street, 900588, <br>Constanta, Romania").openPopup();
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-96 w-full bg-gradient-to-r from-blue-700 to-blue-900 flex items-center">
        <div className="absolute inset-0 opacity-30">
          <Image
            src="/Home2.jpg"
            alt="Romania maritime background"
            fill
        ...
        <div className="container mx-auto px-4 z-10">
          <h1 className="text-5xl font-bold text-white mb-4">Romania</h1>
        </div>
      </section>
      ...
      <section className="container mx-auto py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-10">
            <h2 className="text-3xl font-bold text-center text-blue-800 mb-6">Our Presence in Romania</h2>

            <p className="text-lg mb-6">
              European seafarers have lately showcased a decline in numbers but some nations still proudly continue a long-lasting seafaring tradition in the new millennium. Romania is one of those countries, which exemplify the quality of European seafarers at large.
            </p>
            
            <p className="text-lg mb-8">
Epsilon is present in Romania through its branch in Constanta, which is the traditional source of Romanian seafarers and a hub of maritime education in the country.            </p>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-blue-50 p-6 rounded-lg shadow-md mb-8">
              <h3 className="text-2xl font-semibold mb-4 text-blue-800">EPSILON ROMANIA</h3>
              <div>
                <p className="mb-2">
                ...
                <p className="mb-4">
                  ...
                  <strong>Email:</strong> crew@epsilonhellas.ro
                </p>
                <button
            ...
            <div className="bg-white border border-gray-200 p-8 rounded-lg shadow-md">
              ...
              <p className="mb-6">Send us a message and our team in Romania will get back to you as soon as possible.</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-lg shadow-lg w-11/12 md:w-3/4 lg:w-2/3 max-w-4xl mx-auto overflow-hidden">
            <div className="p-4 border-b flex justify-between items-center">
              <h3 className="text-xl font-semibold">EPSILON ROMANIA - Constanta, Romania</h3>
              <button
