  ...
  useEffect(() => {
    if (showMapPopup && !mapInitializedRef.current) {
      ...
      import('leaflet').then(L => {
        ...
        // Define the coordinates for Hai Phong, Vietnam
        const haiPhong: LatLngTuple = [20.8449, 106.6881]; // [latitude, longitude]
        ...
        const marker = L.marker(haiPhong, { icon: customIcon }).addTo(map);
        marker.bindPopup("EPSILON VIETNAM OFFICE<br>12th Floor, Akashi Building, Hai Phong City").openPopup();
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-96 w-full bg-gradient-to-r from-blue-700 to-blue-900 flex items-center">
        <div className="absolute inset-0 opacity-30">
          <Image
            src="/Home2.jpg"
            alt="Vietnam maritime background"
            fill
        ...
        <div className="container mx-auto px-4 z-10">
          <h1 className="text-5xl font-bold text-white mb-4">Vietnam</h1>
        </div>
      </section>
      ...
      <section className="container mx-auto py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-10">
            <h2 className="text-3xl font-bold text-center text-blue-800 mb-6">Our Presence in Vietnam</h2>

            <div className="mb-6">
              <p className="text-lg mb-4">
                Vietnam is the emerging powerhouse of seafaring talent. A proud nation with an advanced maritime education infrastructure and one of the fastest-growing investment centers of Southeast Asia. The development of the country and its accelerated openness to the rest of the world has created one of the world’s greatest value-for-money propositions in terms of crewing solutions. Our base is at the marine hub of the country -Hai Phong- and serves Principals with the preparation and dispatch of experienced officers and crew.
              </p>
            </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-blue-50 p-6 rounded-lg shadow-md mb-8">
              <h3 className="text-2xl font-semibold mb-4 text-blue-800">EPSILON VIETNAM OFFICE</h3>
              <div>
                <p className="mb-2">
                  12th Floor, Akashi Building No 10 Block<br />
                  2A Le Hong Phong St, Ngo Quyen Dist<br />
                  Hai Phong City – Vietnam
                </p>
                <p className="mb-4">
                  <strong>Email:</strong> contact@epsilonhellas.com
                </p>
                <button
            ...
            <div className="bg-white border border-gray-200 p-8 rounded-lg shadow-md">
              ...
              <p className="mb-6">Send us a message and our team in Vietnam will get back to you as soon as possible.</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-lg shadow-lg w-11/12 md:w-3/4 lg:w-2/3 max-w-4xl mx-auto overflow-hidden">
            <div className="p-4 border-b flex justify-between items-center">
              <h3 className="text-xl font-semibold">EPSILON VIETNAM OFFICE - Hai Phong, Vietnam</h3>
              <button
            ...
            <div className="p-4 bg-blue-50">
              <p>
                <strong>Address:</strong> 12th Floor, Akashi Building No 10 Block, 2A Le Hong Phong St, Ngo Quyen Dist, Hai Phong City – Vietnam<br />
                <strong>Email:</strong> contact@epsilonhellas.com
              </p>
            </div>
          </div>
