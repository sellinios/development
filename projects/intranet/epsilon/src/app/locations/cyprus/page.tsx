  ...
  useEffect(() => {
    if (showMapPopup && !mapInitializedRef.current) {
      ...
      import('leaflet').then(L => {
        ...
        // Define the exact coordinates for Epsilon Hellas office in Limassol, Cyprus
        const epsilonOffice: LatLngTuple = [34.6828, 33.0439];
        ...
        marker.bindPopup("<strong>Epsilon Hellas (OVERSEAS) LTD</strong><br>113-115 Vasileos Konstantinou Str.<br>3080 Limassol, Cyprus").openPopup();
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-96 w-full bg-gradient-to-r from-blue-700 to-blue-900 flex items-center">
        <div className="absolute inset-0 opacity-30">
          <Image
            src="/Home2.jpg"
            alt="Cyprus maritime background"
            fill
        ...
        <div className="container mx-auto px-4 z-10">
          <h1 className="text-5xl font-bold text-white mb-4">Cyprus</h1>
        </div>
      </section>
      ...
      <section className="container mx-auto py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-10">
            <h2 className="text-3xl font-bold text-center text-blue-800 mb-6">Our Cyprus Headquarters</h2>

            <div className="mb-8">
              <p className="text-lg mb-4">
                We are headquartered in Cyprus, the location of our senior management office.
                Building upon a robust maritime tradition that is associated with the country's heritage,
                we deploy our international operations with a view to serving seafarers' and Principals'
                needs in transparent and ethical ways.
              </p>
          ...
          <div className="mb-12">
            ...
            <div className="bg-blue-50 p-6 rounded-lg shadow-md mb-8">
              <h3 className="text-2xl font-semibold mb-4 text-blue-800">EPSILON HELLAS (OVERSEAS) LTD</h3>
              <div>
                <p className="mb-2">
                  113-115 Vasileos Konstantinou Str.<br />
                  3080 Limassol – Cyprus
                </p>
                <p className="mb-1">
                  <strong>Tel:</strong> +357 25266050
                </p>
                <p className="mb-4">
            ...
            <div className="bg-white border border-gray-200 p-8 rounded-lg shadow-md">
              ...
              <p className="mb-6">Send us a message and our team in Cyprus will get back to you as soon as possible.</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-lg shadow-lg w-11/12 md:w-3/4 lg:w-2/3 max-w-4xl mx-auto overflow-hidden">
            <div className="p-4 border-b flex justify-between items-center">
              <h3 className="text-xl font-semibold">Epsilon Hellas (OVERSEAS) LTD - Limassol, Cyprus</h3>
              <button
            ...
            <div className="p-4 bg-blue-50">
              <p>
                <strong>Address:</strong> 113-115 Vasileos Konstantinou Str., 3080 Limassol, Cyprus<br />
                <strong>Tel:</strong> +357 25266050<br />
                <strong>Email:</strong> crew@epsilonhellas.com
              </p>
            </div>
          </div>
