  ...
  useEffect(() => {
    if (showMapPopup && !mapInitializedRef.current) {
      ...
      import('leaflet').then(L => {
        ...
        // Define the coordinates for Glyfada, Greece
        const glyfada: LatLngTuple = [37.8697, 23.7551]; // [latitude, longitude]
        ...
        const marker = L.marker(glyfada, { icon: customIcon }).addTo(map);
        marker.bindPopup("Epsilon Hellas<br>Leoforos Vouliagmenis, 120-122, Glyfada").openPopup();
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-96 w-full bg-gradient-to-r from-blue-700 to-blue-900 flex items-center">
        <div className="absolute inset-0 opacity-30">
          <Image
            src="/Home2.jpg"
            alt="Greece maritime background"
            fill
        ...
        <div className="container mx-auto px-4 z-10">
          <h1 className="text-5xl font-bold text-white mb-4">Greece</h1>
        </div>
      </section>
      ...
      <section className="container mx-auto py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-10">
            <h2 className="text-3xl font-bold text-center text-blue-800 mb-6">Our Presence in Greece</h2>

            <div className="mb-8">
              <p className="text-lg mb-4">
                Greece has an ancient-long affair with the sea, the latter being a constitutive element of the country’s culture. Epsilon was born out of and is constantly nurtured by this relationship, which acts as an inspiration and focus alike.
              </p>
              <p className="text-lg mb-6">
                We are an elite company located in Glyfada, Greece and we consider our presence in the country as a privilege, as a responsibility, and as a constant learning vehicle for all of us in Epsilon.
              </p>
          ...
          <div className="mb-12">
            ...
            <div className="bg-blue-50 p-6 rounded-lg shadow-md mb-8">
              <h3 className="text-2xl font-semibold mb-4 text-blue-800">Epsilon Hellas</h3>
              <div>
                <p className="mb-2">
                  Leoforos Vouliagmenis, 120-122<br />
                  Glyfada, 16674<br />
                  Greece
                </p>
                <p className="mb-1">
                  <strong>Tel:</strong> +30 210 45 51 500
                </p>
                <p className="mb-4">
                  <strong>Email:</strong> crew@epsilonhellas.com
                </p>
                <button
            ...
            <div className="bg-white border border-gray-200 p-8 rounded-lg shadow-md">
              ...
              <p className="mb-6">Send us a message and our team in Greece will get back to you as soon as possible.</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-lg shadow-lg w-11/12 md:w-3/4 lg:w-2/3 max-w-4xl mx-auto overflow-hidden">
            <div className="p-4 border-b flex justify-between items-center">
              <h3 className="text-xl font-semibold">Epsilon Hellas - Glyfada, Greece</h3>
              <button
            ...
            <div className="p-4 bg-blue-50">
              <p>
                <strong>Address:</strong> Leoforos Vouliagmenis, 120-122, Glyfada, 16674, Greece<br />
                <strong>Tel:</strong> +30 210 45 51 500<br />
                <strong>Email:</strong> crew@epsilonhellas.com
              </p>
            </div>
          </div>
