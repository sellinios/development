...
export default function UkrainePage() {
  ...
  // State to track which location is being viewed
  ...
  const openMapPopup = (location: 'office' | 'training') => {
  ...
  useEffect(() => {
    if (showMapPopup && !mapInitializedRef.current) {
      ...
      import('leaflet').then(L => {
        ...
        // Define the coordinates for Odesa, Ukraine
        const odesa: LatLngTuple = [46.4366, 30.7554]; // Approximate coordinates for Frantsuz'ky Blvd
        ...
        const marker = L.marker(odesa, { icon: customIcon }).addTo(map);

        // Set popup content based on current location
        const popupContent = currentLocation === 'office'
          ? "EPSILON MARITIME SERVICES LTD<br>Frantsuz'ky Blvd, 54/23, Odesa, Ukraine"
          : "EPSILON MARITIME TRAINING AND EDUCATIONAL CENTER<br>Frantsuz'ky Blvd, 54/23, Odesa, Ukraine";
  ...
  }, [showMapPopup, currentLocation]);

  // Reset initialization when map popup is closed
  useEffect(() => {
    if (!showMapPopup && mapInitializedRef.current) {
      if (mapRef.current) {
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-96 w-full bg-gradient-to-r from-blue-700 to-blue-900 flex items-center">
        <div className="absolute inset-0 opacity-30">
          <Image
            src="/Home2.jpg"
            alt="Ukraine maritime background"
            fill
        ...
        <div className="container mx-auto px-4 z-10">
          <h1 className="text-5xl font-bold text-white mb-4">Ukraine</h1>
        </div>
      </section>
      ...
      <section className="container mx-auto py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-10">
            <h2 className="text-3xl font-bold text-center text-blue-800 mb-6">Our Presence in Ukraine</h2>

            <div className="mb-6">
              <p className="text-lg mb-4">
                Ukraine is an archetypical example of a proud maritime nation with close links to the sea. Ukrainian seafarers are renowned for their stamina and perseverance being the crew of choice for some of the most reputable Principals in the world.
              </p>
              <p className="text-lg mb-4">
                Epsilon has a long-standing presence in the Ukrainian market. More specifically, our office is located in one of the major ports of the country, Odessa. From this office, Epsilon manages a pool of several thousand officers and ratings, which are employed by a large percentage of our client base. Additionally, we safeguard the constant upgrading of our seafarers’ skills through our state-of-the-art training center in Odessa.
              </p>
            </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-blue-50 p-6 rounded-lg shadow-md mb-8">
              <h3 className="text-2xl font-semibold mb-4 text-blue-800">EPSILON MARITIME SERVICES LTD</h3>
              <div>
                <p className="mb-2">
                  Frantsuz'ky Blvd, 54/23<br />
                  Odesa, Odes'ka oblast, 65000<br />
                  Ukraine
                </p>
                <p className="mb-1">
                ...
                <p className="mb-4">
                  <strong>Email:</strong> crew@epsilonhellas.com.ua
                </p>
                <button
            ...
            <div className="bg-blue-50 p-6 rounded-lg shadow-md mb-8">
              <h3 className="text-2xl font-semibold mb-4 text-blue-800">EPSILON MARITIME TRAINING AND EDUCATIONAL CENTER</h3>
              <div>
                <p className="mb-2">
                  Frantsuz'ky Blvd, 54/23<br />
                  Odesa, Odes'ka oblast, 65000<br />
            ...
            <div className="bg-white border border-gray-200 p-8 rounded-lg shadow-md">
              ...
              <p className="mb-6">Send us a message and our team in Ukraine will get back to you as soon as possible.</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-lg shadow-lg w-11/12 md:w-3/4 lg:w-2/3 max-w-4xl mx-auto overflow-hidden">
            <div className="p-4 border-b flex justify-between items-center">
              <h3 className="text-xl font-semibold">
                {currentLocation === 'office'
                  ? "EPSILON MARITIME SERVICES LTD - Odesa, Ukraine"
                  : "EPSILON MARITIME TRAINING AND EDUCATIONAL CENTER - Odesa, Ukraine"}
              </h3>
              <button
            ...
            <div className="p-4 bg-blue-50">
              <p>
                <strong>Address:</strong> Frantsuz'ky Blvd, 54/23, Odesa, Odes'ka oblast, 65000, Ukraine<br />
                <strong>Tel:</strong> +380 48 728 00 62<br />
                <strong>Email:</strong> {currentLocation === 'office' ? "crew@epsilonhellas.com.ua" : "training@epsilonhellas.com.ua"}
              </p>
            </div>
          </div>
        </div>
